...
function tripal_sra_add_cvterms() {
  ...
  $selections = array(
    ...
    'other' => 'Other library enrichment, screening, or selection process (please include additional info in the â€œdesign descriptionâ€�)',
    'unspecified' => 'Library enrichment, screening, or selection is not specified (please include additional info in the â€œdesign descriptionâ€�)',
  );
